...
When code fails I first start by reading the error or warning message. I try to debug myself by reviewing my code to see if I made a simple mistake. Then I usually paste the error message or warning into Google. I read Stackoverflow, and then if I still can not fix my code I ask Chat. The browser function will very useful when I want to understand line by line what is happening in a function / for loop. 
